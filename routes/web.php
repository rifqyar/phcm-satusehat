...
Route::middleware(['checkLogin'])->group(function () {
    ...
    Route::group(['prefix' => 'satu-sehat', 'as' => 'satusehat.'], function () {
        ...
        Route::get('/medication-request/prepsatusehat', [App\Http\Controllers\SatuSehat\MedicationRequestController::class, 'prepMedicationRequest'])->name('medication-request.sendsehat');
