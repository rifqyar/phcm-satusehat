...
Route::middleware(['checkLogin'])->group(function () {
    ...
    Route::group(['prefix' => 'satu-sehat', 'as' => 'satusehat.'], function () {
        ...
        Route::get('/service-request/resend/{param}', [App\Http\Controllers\SatuSehat\ServiceRequestController::class, 'resendSatuSehat'])->name('service-request.resend');
        ...
        Route::get('/specimen/resend/{param}', [App\Http\Controllers\SatuSehat\SpecimenController::class, 'resendSatuSehat'])->name('specimen.resend');
