        ...
        <div class="card-body">
            ...
            <div class="col-12 col-md-12">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-rounded btn-info" onclick="search('all')">
                        Cari Data
    ...
    @push('after-script')
        ...
        <script>
            ...
            $(document).ready(function() {
                // set default range
                var endDate = moment(); // hari ini
                var startDate = moment().subtract(21, 'days'); // 21 hari ke belakang
