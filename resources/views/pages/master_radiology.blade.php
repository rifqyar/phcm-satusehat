    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <!-- Total -->
                <div class="col-md-4">
                    <a href="{{ route('master_radiology', ['mapped_filter' => 'all', 'search' => request('search')]) }}"
                        class="text-decoration-none">
                        <div class="card shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="mr-3">
                                    <i
                                        class="fas fa-radiation fa-2x {{ request('mapped_filter') == '' || request('mapped_filter') == 'all' ? 'text-primary' : 'text-secondary' }}"></i>
                                </div>
                                <div>
                                    <h6
                                        class="{{ request('mapped_filter') == '' || request('mapped_filter') == 'all' ? 'text-primary' : 'text-secondary' }} mb-0">
                                        Total Tindakan Radiology</h6>
                ...
                <!-- Sudah Dimapping -->
                <div class="col-md-4">
                    <a href="{{ route('master_radiology', ['mapped_filter' => 'mapped', 'search' => request('search')]) }}"
                        class="text-decoration-none">
                        <div class="card shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="mr-3">
                ...
                <!-- Belum Dimapping -->
                <div class="col-md-4">
                    <a href="{{ route('master_radiology', ['mapped_filter' => 'unmapped', 'search' => request('search')]) }}"
                        class="text-decoration-none">
                        <div class="card shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="mr-3">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari nama atau kode tindakan radiology..." value="{{ request('search') }}">
...
@push('after-script')
    ...
    <script>
        $('#btnSaveMapping').on('click', function() {
            let formData = $('#formMappingRadiology').serializeArray();
