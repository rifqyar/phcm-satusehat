...
<div class="modal fade" id="modalDiagnosticReport" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Detail Diagnostic Report Pasien</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-header bg-primary ">
                        <h6 class="m-0 text-white"><i class="fas fa-hospital"></i> Data Tindakan</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" id="tableDiagnosticReport">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Nama Tindakan</th>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div id="integrasi_service_request" class="alert alert-info" style="display:none;">
                            <i class="fas fa-info-circle"></i> Service Request Belum Terintegrasi dengan SatuSehat
                        </div>
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" class="btn btn-primary" id="btn-send-satusehat" style="display: none;">
