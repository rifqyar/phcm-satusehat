...
class ImagingStudyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.satusehat.imaging-study.index', compact('result'));
    }
    ...
    public function datatable(Request $request)
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $idTransaksi = str_pad(rand(00000, 99999), 5, '0', STR_PAD_LEFT);
            ...
            $rows[] = [
                ...
                'NO_PESERTA' => '001.' . str_pad(rand(100000, 999999), 6, '0', STR_PAD_LEFT),
                'KBUKU' => str_pad(rand(100000, 999999), 6, '0', STR_PAD_LEFT),
                'NAMA' => self::generateName(),
                'TGL_MASUK' => Carbon::now()->subDays($i)->format('Y-m-d'),
                'DOKTER' => 'Dr. ' . self::generateName(),
